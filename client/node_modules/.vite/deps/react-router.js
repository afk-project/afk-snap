...
function useRoute(...args) {
  ...
  return {
    ...
    actionData: data2.actionData?.[id]
  };
}
...
function createStaticRouter(routes, context, opts = {}) {
  ...
  return {
    ...
    match(locationArg) {
      return matchRoutes2(locationArg)?.map(mapRouteMatch) ?? null;
    },
    initialize() {
